...
export default function AdminDashboard() {
  ...
  const startStream = async (id: string) => {
    // Navigate first to ensure the broadcaster can get to the panel
    navigate(`/broadcast/${id}`);
    
    try {
      // Try to mark as active in Supabase in the background
      ...
      // We don't alert here as we already navigated
    }
  };
      ...
      <div className="max-w-[1200px] mx-auto">
        <header className="flex justify-between items-end mb-12">
          <div className="space-y-1">
            ...
            <h1 className="text-5xl font-black tracking-tighter italic uppercase">ტრანსლაციის <span className="text-brand-primary">ცენტრი</span></h1>
            <p className="text-zinc-500 font-bold uppercase text-xs tracking-widest">ქსელის ადმინისტრატორის გარემო</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <section className="col-span-12 md:col-span-12 lg:col-span-12 space-y-6">
            <h2 className="text-xs font-black uppercase tracking-[0.3em] text-zinc-500">აქტიური და დაგეგმილი ლაივების მართვა</h2>
