...
export function Sidebar() {
  ...
  return (
    <aside className="fixed sm:left-0 bottom-0 sm:top-0 h-[calc(68px+env(safe-area-inset-bottom,0px))] sm:h-full w-full sm:w-20 bg-brand-surface/95 backdrop-blur-xl border-t sm:border-t-0 sm:border-r border-brand-border flex sm:flex-col flex-row items-center justify-around sm:justify-start sm:py-6 pb-[env(safe-area-inset-bottom,4px)] pt-[2px] sm:pb-6 z-[60]">
