...
export function TeamLogo({ name, logoUrl, className = 'w-full h-full' }: TeamLogoProps) {
  ...
  const teamConfigMap: Record<string, { bg: string; text: string; initials: string; border: string }> = {
    ...
    'celta': { bg: 'from-sky-300 to-sky-500', border: 'border-sky-400/30', text: 'text-sky-950', initials: 'CEL' },
    'celta vigo': { bg: 'from-sky-300 to-sky-500', border: 'border-sky-400/30', text: 'text-sky-950', initials: 'CEL' },
    'getafe': { bg: 'from-blue-600 to-blue-800', border: 'border-blue-500/30', text: 'text-white', initials: 'GET' },
    'real sociedad': { bg: 'from-blue-500 to-zinc-100', border: 'border-blue-400/30', text: 'text-blue-950', initials: 'RSO' },
    ...
    'espanyol': { bg: 'from-blue-500 to-zinc-100', border: 'border-blue-400/30', text: 'text-blue-950', initials: 'ESP' },
    'girona': { bg: 'from-red-600 to-zinc-100', border: 'border-red-400/30', text: 'text-red-955', initials: 'GIR' },
    'alavés': { bg: 'from-blue-600 to-zinc-100', border: 'border-blue-450/30', text: 'text-blue-950', initials: 'ALA' },
    'alaves': { bg: 'from-blue-600 to-zinc-100', border: 'border-blue-450/30', text: 'text-blue-950', initials: 'ALA' },
    ...
    'real oviedo': { bg: 'from-blue-800 to-zinc-100', border: 'border-blue-600/30', text: 'text-blue-950', initials: 'OVI' }
  };
